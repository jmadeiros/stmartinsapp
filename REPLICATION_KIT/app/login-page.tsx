...
import { CanvasRevealEffect } from "@/components/aitrium/canvas-reveal-effect";
import SphereImageGrid, {
  ImageData,
} from "@/components/aitrium/sphere-image-grid";
...
const SignInPage = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      className={cn(
        "relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-white to-primary/10 text-slate-900",
        className,
      )}
    >
            ...
            >
              ...
              <div className="w-full max-w-md space-y-8">
                <div className="space-y-4">
                  <button className={oauthButtonClasses}>
                    <svg
                      className="w-5 h-5"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
