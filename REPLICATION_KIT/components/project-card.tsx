  ...
  return (
    <Card className="border border-border bg-card shadow-sm transition-shadow hover:shadow-md">
      <div className="p-6">
        ...
        <div className="mb-4 rounded-xl bg-gradient-to-r from-primary/5 to-accent/5 p-4 border border-primary/20">
                ...
                <AnimatePresence initial={false}>
                  {interested && supportPanelOpen && (
                    <motion.div
                      ...
                      className={cn(
                        "absolute z-30 w-64 rounded-lg border border-emerald-200/60 bg-white/98 p-3 shadow-lg backdrop-blur-sm",
