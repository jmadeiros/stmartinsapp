...
export function Header() {
  ...
  return (
    <motion.header 
      ...
      className="sticky top-0 z-50 border-b border-border/40 bg-[var(--overlay)]/95 backdrop-blur-xl supports-[backdrop-filter]:bg-[var(--overlay)]/80 relative overflow-hidden"
    >
      {/* Animated gradient background */}
      <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-primary/5 to-transparent pointer-events-none animate-gradient" />
