...
interface PostMenuProps {
  ...
  onDelete?: () => void
  onToggleStatus?: () => void
  onUpdateProgress?: () => void  // Projects only
  onAddEvent?: () => void         // Projects only
  onLinkEvent?: () => void        // Projects only
  onAttachToProject?: () => void  // Events only
  onDetachFromProject?: () => void // Events only (if linked)
  onLinkToEvent?: () => void      // Posts only
  onLinkToProject?: () => void    // Posts only
  hasParentProject?: boolean       // For events
}
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        {/* Close/Reopen for events and projects */}
