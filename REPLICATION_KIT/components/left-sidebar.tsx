  ...
  return (
    <aside className="hidden lg:block">
      <div className="sticky top-24 space-y-6">
        ...
        >
          <Card
            className="border-0 bg-gradient-to-br from-chart-2 via-chart-1/80 to-chart-5 p-6 overflow-hidden relative"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl font-semibold text-white/95">Michael</p>
            </div>
          </Card>
        </motion.div>
