...
import { AnimatedEvents } from "@/components/animated-events"
      ...
      <div className="sticky top-24 space-y-4">
        <AnimatePresence mode="wait">
          {!alertDismissed ? (
            ...
            >
              <Card
                className="border border-border/50 bg-[var(--surface)] overflow-hidden p-0"
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    There will be a scheduled electricity outage on Monday, August 15th from 9:00 AM to 12:00 PM. Please
                    save your work and power down non-essential equipment.
                  </p>
                </div>
