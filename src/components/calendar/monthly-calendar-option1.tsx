...
/**
 * OPTION 1: Compact Header Row (No Bar)
 * Clean, minimal header with month/navigation on left, quick stats on right
 */
...
export function MonthlyCalendarOption1({ events, initialDate }: MonthlyCalendarProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_380px]">
      ...
      <div className="space-y-4">
        {/* OPTION 1: Compact header with green gradient fade (like Good Morning box) */}
        <motion.div
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-medium text-white/70 uppercase tracking-wide">Calendar</span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <Button
                  ...
                  className="text-xs font-medium bg-white/20 hover:bg-white/30 text-white border-0 backdrop-blur-sm"
                >
                  Today
                </Button>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/15 backdrop-blur-sm">
                  <div className="flex items-center gap-1.5 text-sm">
                    <span className="font-bold text-white">{eventsInCurrentMonth.length}</span>
                    <span className="text-white/80">events this month</span>
                  </div>
                </div>
                {nextEvent && (
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/10 backdrop-blur-sm">
                    ...
                    <span className="text-sm font-medium text-white max-w-[150px] truncate">{nextEvent.title}</span>
                  </div>
                )}
              </div>
            </div>
        ...
        >
          ...
          >
            {dayLabels.map(label => (
              <div key={label} className="py-2.5 text-center text-xs font-semibold uppercase tracking-wider text-white/90">
                {label}
              </div>
            ))}
          </div>
