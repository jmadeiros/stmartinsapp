...
const coreAttendees: CalendarAttendee[] = [
  {
    id: "rico-oktananda",
    name: "Rico Oktananda",
...
export const mockMonthlyEvents: CalendarEvent[] = [
  {
    id: "startup-pitch",
    title: "Startup Pitch Practice",
    description:
      "Practice your 5-minute pitch in front of a friendly audience. Feedback guaranteed.",
    ...
    attendees: coreAttendees,
    kind: "work",
    notes: "Please prepare a 5-minute pitch deck. We'll have time for Q&A after each presentation.",
  },
  {
    id: "event-aug-04-daily-checkin",
    title: "Daily checkin - MVP discussion",
    description:
      "Sprint alignment with the Nova product pod. We'll finalize scope for the AI conductor and memoir completion flows.",
    start: "2024-08-04T09:00:00+07:00",
    end: "2024-08-04T10:00:00+07:00",
    timezone: "GMT+7 Pontianak",
    meetingPlatform: "Google Meet",
    meetingUrl: "https://meet.google.com/dra-jhgg-mvn",
    ...
    reminderMinutes: 30,
    notes:
      "During today's daily check-in, we had an in-depth discussion about the MVP deliverables. Focus on AI-assisted interviews and memoir completion experience.",
    tags: ["MVP", "AI copilots", "Product"],
    kind: "meeting",
    location: "Remote",
  },
  {
    id: "event-aug-04-ux",
    title: "Call with Rico Oktananda - UX Designer",
    description: "Portfolio review and offer discussion for contract UX engagement.",
    start: "2024-08-04T10:00:00+07:00",
    end: "2024-08-04T11:30:00+07:00",
    meetingPlatform: "Google Meet",
    ...
    attendees: coreAttendees.slice(0, 2),
    kind: "interview",
  },
  {
    id: "event-aug-05-intro",
    title: "Intro call with Nova - Product Manager",
    description: "Introduction meeting with Nova's PM team to discuss collaboration opportunities.",
    start: "2024-08-05T10:00:00+07:00",
    end: "2024-08-05T11:00:00+07:00",
    meetingPlatform: "Zoom",
    ...
    attendees: coreAttendees.slice(0, 3),
    kind: "meeting",
  },
  {
    id: "event-aug-05-workshop",
    title: "Design Workshop - User Flows",
    description: "Collaborative workshop to map out user flows for the new onboarding experience.",
    start: "2024-08-05T14:00:00+07:00",
    end: "2024-08-05T16:00:00+07:00",
  ...
  {
    id: "event-aug-06-training",
    title: "Team Training - New Tools",
    description: "Training session on the new design and development tools we'll be adopting.",
    start: "2024-08-06T09:00:00+07:00",
    end: "2024-08-06T12:00:00+07:00",
    meetingPlatform: "Google Meet",
  ...
  {
    id: "event-aug-07-partner",
    title: "Partner Sync - Community Outreach",
    description: "Monthly sync with our community partners to align on upcoming initiatives.",
    start: "2024-08-07T15:00:00+07:00",
    end: "2024-08-07T16:00:00+07:00",
    ...
    attendees: coreAttendees.slice(0, 4),
    kind: "partner",
  },
  {
    id: "event-aug-08-milestone",
    title: "Q3 Milestone Review",
    description: "Review of Q3 milestones and planning for Q4 objectives.",
    start: "2024-08-08T10:00:00+07:00",
    end: "2024-08-08T12:00:00+07:00",
